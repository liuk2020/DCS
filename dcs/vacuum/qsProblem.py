    ...
    def solve_biobject(self, logger, weight: List[float], **kwargs):
        ...
        def callbackFun(xi):
            ...
            if self.niter%10 == 0:
                ...
                logger.info("{:>8d} {:>14e} {:>14e} {:>14e} {:>14e}".format(self.niter, costF, costG, self.iota, ans))
        ...
        _ans = weight[0]*_costF + weight[1]*_costG
        logger.info("{:>8d} {:>14e} {:>14e} {:>14e} {:>14e}".format(self.niter, _costF, _costG, self.iota, _ans)) 
